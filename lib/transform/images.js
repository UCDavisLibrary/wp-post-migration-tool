...
function transformElement(window, ele) {
  ...
  if ( !caption ) caption = ele.parentElement.querySelector('figcaption');
  ...
  let comment = window.document.createComment(` wp:image ${JSON.stringify(gbParams)} `);
