...
const config = {
  ...
  libguides : {
    host : 'https://guides.library.ucdavis.edu',
  ...
  sink : {
    host :  'http://localhost:3000', //env.SINK_HOST || 'http://sandbox.library.ucdavis.edu',
    apiPath : '/wp-json/wp/v2',
    redirectApiPath : '/wp-json/redirection/v1/redirect',
    username : 'sbagg', //env.SINK_API_USERNAME || '',
    key : '9Ler mwpF rTFV Y50w yCwU kwRV', //env.SINK_API_KEY || '',
  },
